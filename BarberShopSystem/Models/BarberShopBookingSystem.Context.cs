...
namespace BarberShopSystem.Models
{
    ...
    public partial class BarberShopEntities3 : DbContext
    {
        public BarberShopEntities3()
            : base("name=BarberShopEntities3")
        {
        }
        ...
        public virtual DbSet<BarberShopService> BarberShopServices { get; set; }
